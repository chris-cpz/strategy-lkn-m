...
[![GitHub Stars](https://img.shields.io/github/stars/chris-cpz/strategy-lkn-m?style=for-the-badge&logo=github)](https://github.com/chris-cpz/strategy-lkn-m)
...
```bash
# Clone repository
git clone https://github.com/chris-cpz/strategy-lkn-m.git
cd strategy-lkn-m
...
```python
from strategy import lknmStrategy

# Initialize strategy
strategy = lknmStrategy()
...
- **Documentation**: [Wiki](https://github.com/chris-cpz/strategy-lkn-m/wiki)
- **Issues**: [GitHub Issues](https://github.com/chris-cpz/strategy-lkn-m/issues)
- **Discussions**: [GitHub Discussions](https://github.com/chris-cpz/strategy-lkn-m/discussions)
